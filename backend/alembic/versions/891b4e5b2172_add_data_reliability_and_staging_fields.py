...
down_revision: Union[str, Sequence[str], None] = '39c2f0a11e2'
...
def upgrade() -> None:
    ...
    op.add_column('pipeline_nodes', sa.Column('write_strategy', sa.String(50), nullable=False, server_default='append'))
    op.add_column('pipeline_nodes', sa.Column('schema_evolution_policy', sa.String(50), nullable=False, server_default='strict'))
    
    # 2. Update connections table
    op.add_column('connections', sa.Column('staging_connection_id', sa.Integer(), nullable=True))
    op.create_foreign_key(
        'fk_connection_staging_id', 
        'connections', 'connections', 
        ['staging_connection_id'], ['id'], 
        ondelete='SET NULL'
    )
