...
Revision ID: ebaf7089e604
Revises:
Create Date: 2026-01-11 21:26:05.185245
...
def upgrade() -> None:  # noqa: PLR0915
    ...
    op.create_table(
        ...
        sa.Column(
            "status",
            sa.Enum("ONLINE", "OFFLINE", "BUSY", "MAINTENANCE", name="agentstatus"),
            nullable=False,
        ),
    ...
    op.create_index(
        op.f("ix_agents_created_at"), "agents", ["created_at"], unique=False
    )
    op.create_index(
        op.f("ix_agents_created_by"), "agents", ["created_by"], unique=False
    )
    op.create_index(
        op.f("ix_agents_deleted_at"), "agents", ["deleted_at"], unique=False
    )
    op.create_index(
    ...
    op.create_table(
        ...
        sa.Column("updated_at", sa.DateTime(timezone=True), nullable=False),
        sa.ForeignKeyConstraint(
            ["active_workspace_id"], ["workspaces.id"], ondelete="SET NULL"
        ),
        sa.PrimaryKeyConstraint("id"),
    )
    ...
    op.create_index(
        "idx_alert_config_enabled",
        "alert_configs",
        ["enabled", "alert_type"],
        unique=False,
    )
    op.create_index(
        op.f("ix_alert_configs_created_at"),
        "alert_configs",
        ["created_at"],
        unique=False,
    )
    op.create_index(
        op.f("ix_alert_configs_created_by"),
        "alert_configs",
        ["created_by"],
        unique=False,
    )
    op.create_index(
        op.f("ix_alert_configs_deleted_at"),
        "alert_configs",
        ["deleted_at"],
        unique=False,
    )
    op.create_index(
        op.f("ix_alert_configs_enabled"), "alert_configs", ["enabled"], unique=False
    )
    op.create_index(
        op.f("ix_alert_configs_name"), "alert_configs", ["name"], unique=False
    )
    op.create_table(
        "api_keys",
        sa.Column("id", sa.Integer(), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column(
            "last_schema_discovery_at", sa.DateTime(timezone=True), nullable=True
        ),
    ...
    op.create_index(
        op.f("ix_connections_created_by"), "connections", ["created_by"], unique=False
    )
    op.create_index(
        op.f("ix_connections_deleted_at"), "connections", ["deleted_at"], unique=False
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "status",
            sa.Enum(
                "DRAFT", "ACTIVE", "PAUSED", "ARCHIVED", "BROKEN", name="pipelinestatus"
            ),
            nullable=False,
        ),
        ...
        sa.ForeignKeyConstraint(
            ["published_version_id"], ["pipeline_versions.id"], use_alter=True
        ),
        sa.ForeignKeyConstraint(["user_id"], ["users.id"], ondelete="SET NULL"),
        sa.ForeignKeyConstraint(
            ["workspace_id"], ["workspaces.id"], ondelete="CASCADE"
    ...
    op.create_index(
        "idx_pipeline_schedule",
        "pipelines",
        ["schedule_enabled", "schedule_cron"],
        unique=False,
    )
    op.create_index(
        op.f("ix_pipelines_agent_group"), "pipelines", ["agent_group"], unique=False
    )
    op.create_index(
        op.f("ix_pipelines_created_at"), "pipelines", ["created_at"], unique=False
    )
    op.create_index(
        op.f("ix_pipelines_created_by"), "pipelines", ["created_by"], unique=False
    )
    op.create_index(
    ...
    op.create_table(
        ...
        sa.Column(
            "role",
            sa.Enum("ADMIN", "EDITOR", "VIEWER", name="workspacerole"),
            nullable=False,
        ),
        sa.Column("created_at", sa.DateTime(timezone=True), nullable=False),
        sa.Column("updated_at", sa.DateTime(timezone=True), nullable=False),
    ...
    op.create_index(
        op.f("ix_workspace_members_created_at"),
        "workspace_members",
        ["created_at"],
        unique=False,
    )
    ...
    op.create_table(
        ...
        sa.PrimaryKeyConstraint("id"),
        sa.UniqueConstraint(
            "connection_id", "name", name="uq_asset_name_per_connection"
        ),
    )
    op.create_index(
        "idx_asset_source_dest", "assets", ["is_source", "is_destination"], unique=False
    )
    op.create_index(
        op.f("ix_assets_connection_id"), "assets", ["connection_id"], unique=False
    )
    op.create_index(
        op.f("ix_assets_created_at"), "assets", ["created_at"], unique=False
    )
    op.create_index(
        op.f("ix_assets_created_by"), "assets", ["created_by"], unique=False
    )
    op.create_index(
    ...
    op.create_index(
        op.f("ix_environments_connection_id"),
        "environments",
        ["connection_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_environments_created_at"), "environments", ["created_at"], unique=False
    )
    op.create_index(
        op.f("ix_environments_created_by"), "environments", ["created_by"], unique=False
    )
    op.create_table(
        "ephemeral_jobs",
        sa.Column("id", sa.Integer(), nullable=False),
    ...
    op.create_index(
        op.f("ix_ephemeral_jobs_agent_group"),
        "ephemeral_jobs",
        ["agent_group"],
        unique=False,
    )
    op.create_index(
        op.f("ix_ephemeral_jobs_created_at"),
        "ephemeral_jobs",
        ["created_at"],
        unique=False,
    )
    op.create_index(
        op.f("ix_ephemeral_jobs_created_by"),
        "ephemeral_jobs",
        ["created_by"],
        unique=False,
    )
    op.create_index(
        op.f("ix_ephemeral_jobs_job_type"), "ephemeral_jobs", ["job_type"], unique=False
    )
    op.create_index(
        op.f("ix_ephemeral_jobs_status"), "ephemeral_jobs", ["status"], unique=False
    )
    op.create_index(
        op.f("ix_ephemeral_jobs_workspace_id"),
        "ephemeral_jobs",
        ["workspace_id"],
        unique=False,
    )
    ...
    op.create_index(
        "idx_version_published",
        "pipeline_versions",
        ["pipeline_id", "is_published"],
        unique=False,
    )
    op.create_index(
        op.f("ix_pipeline_versions_created_at"),
        "pipeline_versions",
        ["created_at"],
        unique=False,
    )
    op.create_index(
        op.f("ix_pipeline_versions_created_by"),
        "pipeline_versions",
        ["created_by"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_query_history_created_by"),
        "query_history",
        ["created_by"],
        unique=False,
    )
    ...
    op.create_index(
        "idx_scheduler_event_type_time",
        "scheduler_events",
        ["event_type", "timestamp"],
        unique=False,
    )
    op.create_index(
        "idx_scheduler_pipeline_time",
        "scheduler_events",
        ["pipeline_id", "timestamp"],
        unique=False,
    )
    op.create_index(
        op.f("ix_scheduler_events_created_at"),
        "scheduler_events",
        ["created_at"],
        unique=False,
    )
    op.create_index(
        op.f("ix_scheduler_events_created_by"),
        "scheduler_events",
        ["created_by"],
        unique=False,
    )
    op.create_index(
        op.f("ix_scheduler_events_pipeline_id"),
        "scheduler_events",
        ["pipeline_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_scheduler_events_timestamp"),
        "scheduler_events",
        ["timestamp"],
        unique=False,
    )
    ...
    op.create_index(
        "idx_schema_version_discovered",
        "asset_schema_versions",
        ["asset_id", "discovered_at"],
        unique=False,
    )
    op.create_index(
        op.f("ix_asset_schema_versions_asset_id"),
        "asset_schema_versions",
        ["asset_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_asset_schema_versions_created_at"),
        "asset_schema_versions",
        ["created_at"],
        unique=False,
    )
    op.create_index(
        op.f("ix_asset_schema_versions_created_by"),
        "asset_schema_versions",
        ["created_by"],
        unique=False,
    )
    ...
    op.create_index(
        "idx_job_pipeline_status", "jobs", ["pipeline_id", "status"], unique=False
    )
    op.create_index(
        "idx_job_status_created", "jobs", ["status", "created_at"], unique=False
    )
    op.create_index(
        op.f("ix_jobs_celery_task_id"), "jobs", ["celery_task_id"], unique=True
    )
    op.create_index(
        op.f("ix_jobs_correlation_id"), "jobs", ["correlation_id"], unique=False
    )
    ...
    op.create_table(
        ...
        sa.Column("updated_by", sa.String(length=255), nullable=True),
        sa.ForeignKeyConstraint(
            ["destination_asset_id"], ["assets.id"], ondelete="SET NULL"
        ),
        sa.ForeignKeyConstraint(
            ["pipeline_version_id"], ["pipeline_versions.id"], ondelete="CASCADE"
        ),
        sa.ForeignKeyConstraint(
    ...
    op.create_index(
        "idx_node_operator_type", "pipeline_nodes", ["operator_type"], unique=False
    )
    op.create_index(
        op.f("ix_pipeline_nodes_created_at"),
        "pipeline_nodes",
        ["created_at"],
        unique=False,
    )
    op.create_index(
        op.f("ix_pipeline_nodes_created_by"),
        "pipeline_nodes",
        ["created_by"],
        unique=False,
    )
    op.create_index(
        op.f("ix_pipeline_nodes_pipeline_version_id"),
        "pipeline_nodes",
        ["pipeline_version_id"],
        unique=False,
    )
    op.create_table(
        ...
        sa.PrimaryKeyConstraint("id"),
        sa.UniqueConstraint(
            "pipeline_id", "asset_id", name="uq_watermark_pipeline_asset"
        ),
    )
    op.create_index(
        "idx_watermark_updated", "watermarks", ["last_updated"], unique=False
    )
    op.create_index(
        op.f("ix_watermarks_asset_id"), "watermarks", ["asset_id"], unique=False
    )
    op.create_index(
        op.f("ix_watermarks_created_at"), "watermarks", ["created_at"], unique=False
    )
    op.create_index(
        op.f("ix_watermarks_created_by"), "watermarks", ["created_by"], unique=False
    )
    op.create_index(
        op.f("ix_watermarks_pipeline_id"), "watermarks", ["pipeline_id"], unique=False
    )
    op.create_table(
        "alerts",
        sa.Column("id", sa.Integer(), nullable=False),
        ...
        sa.Column(
            "level",
            sa.Enum(
                "INFO", "SUCCESS", "WARNING", "ERROR", "CRITICAL", name="alertlevel"
            ),
            nullable=False,
        ),
        sa.Column(
        ...
        sa.Column("updated_by", sa.String(length=255), nullable=True),
        sa.ForeignKeyConstraint(
            ["alert_config_id"], ["alert_configs.id"], ondelete="SET NULL"
        ),
    ...
    op.create_index(
        "idx_alert_level_status", "alerts", ["level", "status"], unique=False
    )
    op.create_index(
        "idx_alert_pipeline_created",
        "alerts",
        ["pipeline_id", "created_at"],
        unique=False,
    )
    op.create_index(
        "idx_alert_status_created", "alerts", ["status", "created_at"], unique=False
    )
    op.create_index(
        op.f("ix_alerts_alert_config_id"), "alerts", ["alert_config_id"], unique=False
    )
    op.create_index(
        op.f("ix_alerts_created_at"), "alerts", ["created_at"], unique=False
    )
    op.create_index(
        op.f("ix_alerts_created_by"), "alerts", ["created_by"], unique=False
    )
    ...
    op.create_index(
        op.f("ix_alerts_pipeline_id"), "alerts", ["pipeline_id"], unique=False
    )
    ...
    op.create_index(
        "idx_job_log_level_time",
        "job_logs",
        ["job_id", "level", "timestamp"],
        unique=False,
    )
    op.create_index(
        op.f("ix_job_logs_created_at"), "job_logs", ["created_at"], unique=False
    )
    op.create_index(
        op.f("ix_job_logs_created_by"), "job_logs", ["created_by"], unique=False
    )
    ...
    op.create_index(
        op.f("ix_job_logs_timestamp"), "job_logs", ["timestamp"], unique=False
    )
    op.create_table(
        "pipeline_edges",
        sa.Column("id", sa.Integer(), nullable=False),
        ...
        sa.ForeignKeyConstraint(
            ["from_node_id"], ["pipeline_nodes.id"], ondelete="CASCADE"
        ),
        sa.ForeignKeyConstraint(
            ["pipeline_version_id"], ["pipeline_versions.id"], ondelete="CASCADE"
        ),
        sa.ForeignKeyConstraint(
            ["to_node_id"], ["pipeline_nodes.id"], ondelete="CASCADE"
        ),
        sa.ForeignKeyConstraint(
            ["workspace_id"], ["workspaces.id"], ondelete="CASCADE"
        ),
    ...
    op.create_index(
        op.f("ix_pipeline_edges_created_at"),
        "pipeline_edges",
        ["created_at"],
        unique=False,
    )
    op.create_index(
        op.f("ix_pipeline_edges_created_by"),
        "pipeline_edges",
        ["created_by"],
        unique=False,
    )
    op.create_index(
        op.f("ix_pipeline_edges_pipeline_version_id"),
        "pipeline_edges",
        ["pipeline_version_id"],
        unique=False,
    )
    ...
    op.create_index(
        "idx_run_pipeline_created",
        "pipeline_runs",
        ["pipeline_id", "created_at"],
        unique=False,
    )
    op.create_index(
        "idx_run_status_started",
        "pipeline_runs",
        ["status", "started_at"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_pipeline_runs_created_by"),
        "pipeline_runs",
        ["created_by"],
        unique=False,
    )
    op.create_index(
        op.f("ix_pipeline_runs_job_id"), "pipeline_runs", ["job_id"], unique=True
    )
    op.create_index(
    ...
    op.create_index(
        op.f("ix_pipeline_runs_started_at"),
        "pipeline_runs",
        ["started_at"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_pipeline_run_context_created_at"),
        "pipeline_run_context",
        ["created_at"],
        unique=False,
    )
    op.create_index(
        op.f("ix_pipeline_run_context_created_by"),
        "pipeline_run_context",
        ["created_by"],
        unique=False,
    )
    op.create_index(
        op.f("ix_pipeline_run_context_pipeline_run_id"),
        "pipeline_run_context",
        ["pipeline_run_id"],
        unique=True,
    )
    ...
    op.create_index(
        "idx_step_run_node", "step_runs", ["node_id", "status"], unique=False
    )
    op.create_index(
        "idx_step_run_status", "step_runs", ["pipeline_run_id", "status"], unique=False
    )
    op.create_index(
        op.f("ix_step_runs_created_at"), "step_runs", ["created_at"], unique=False
    )
    op.create_index(
        op.f("ix_step_runs_created_by"), "step_runs", ["created_by"], unique=False
    )
    op.create_index(
        op.f("ix_step_runs_pipeline_run_id"),
        "step_runs",
        ["pipeline_run_id"],
        unique=False,
    )
    ...
    op.create_index(
        "idx_step_log_level_time",
        "step_logs",
        ["step_run_id", "level", "timestamp"],
        unique=False,
    )
    op.create_index(
        op.f("ix_step_logs_created_at"), "step_logs", ["created_at"], unique=False
    )
    op.create_index(
        op.f("ix_step_logs_created_by"), "step_logs", ["created_by"], unique=False
    )
    op.create_index(op.f("ix_step_logs_level"), "step_logs", ["level"], unique=False)
    op.create_index(
        op.f("ix_step_logs_step_run_id"), "step_logs", ["step_run_id"], unique=False
    )
    op.create_index(
        op.f("ix_step_logs_timestamp"), "step_logs", ["timestamp"], unique=False
    )
...
def downgrade() -> None:  # noqa: PLR0915
    ...
    op.drop_index(
        op.f("ix_pipeline_run_context_pipeline_run_id"),
        table_name="pipeline_run_context",
    )
    op.drop_index(
        op.f("ix_pipeline_run_context_created_by"), table_name="pipeline_run_context"
    )
    op.drop_index(
        op.f("ix_pipeline_run_context_created_at"), table_name="pipeline_run_context"
    )
    ...
    op.drop_index(
        op.f("ix_pipeline_edges_pipeline_version_id"), table_name="pipeline_edges"
    )
    ...
    op.drop_index(
        op.f("ix_pipeline_nodes_pipeline_version_id"), table_name="pipeline_nodes"
    )
    ...
    op.drop_table("jobs")
    op.drop_index(
        op.f("ix_asset_schema_versions_created_by"), table_name="asset_schema_versions"
    )
    op.drop_index(
        op.f("ix_asset_schema_versions_created_at"), table_name="asset_schema_versions"
    )
    op.drop_index(
        op.f("ix_asset_schema_versions_asset_id"), table_name="asset_schema_versions"
    )
    ...
    op.drop_index(
        op.f("ix_scheduler_events_pipeline_id"), table_name="scheduler_events"
    )
    ...
    op.drop_index(
        op.f("ix_pipeline_versions_created_by"), table_name="pipeline_versions"
    )
    op.drop_index(
        op.f("ix_pipeline_versions_created_at"), table_name="pipeline_versions"
    )
    ...
    op.drop_index(
        op.f("ix_workspace_members_created_at"), table_name="workspace_members"
    )
