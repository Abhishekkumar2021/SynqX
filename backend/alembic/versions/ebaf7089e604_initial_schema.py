...
def upgrade() -> None:
    ...
    sa.Column('alert_type', sa.Enum('JOB_STARTED', 'JOB_FAILURE', 'JOB_SUCCESS', 'DATA_QUALITY_FAILURE', 'SCHEMA_CHANGE_DETECTED', 'SLA_BREACH', 'MANUAL', name='alerttype'), nullable=False),
    ...
    sa.Column('name', sa.String(length=255), nullable=False),
    sa.Column('asset_type', sa.Enum('table', 'view', 'collection', 'file', 'key_pattern', 'endpoint', 'stream', 'sql_query', 'nosql_query', 'python', 'shell', 'javascript', name='assettype'), nullable=False),
