...
class ConnectionBase(BaseModel):
    ...
    staging_connection_id: int | None = Field(
        None,
        description="Connection to use for intermediate staging (e.g. S3 for Snowflake)",  # noqa: E501
    )
...
class ConnectionUpdate(BaseModel):
    ...
    staging_connection_id: int | None = None
