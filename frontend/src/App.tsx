...
const ConnectionDetailsPage = lazy(() =>
  import('./pages/ConnectionDetailsPage').then((module) => ({
    default: module.ConnectionDetailsPage,
  }))
)
const PipelinesListPage = lazy(() =>
  import('./pages/PipelinesListPage').then((module) => ({ default: module.PipelinesListPage }))
)
const PipelineEditorPage = lazy(() =>
  import('./pages/PipelineEditorPage').then((module) => ({ default: module.PipelineEditorPage }))
)
const JobsPage = lazy(() =>
...
const WorkspaceTeamPage = lazy(() =>
  import('./pages/WorkspaceTeamPage').then((module) => ({ default: module.WorkspaceTeamPage }))
)
const AlertsPage = lazy(() =>
  import('./pages/AlertsPage').then((module) => ({ default: module.AlertsPage }))
)
const OperatorsPage = lazy(() =>
  import('./pages/OperatorsPage').then((module) => ({ default: module.OperatorsPage }))
)
const ExplorerPage = lazy(() =>
  import('./pages/ExplorerPage').then((module) => ({ default: module.ExplorerPage }))
)
const OSDUExplorerPage = lazy(() =>
  import('./pages/explorer/OSDUExplorerPage').then((module) => ({
...
const FileExplorerPage = lazy(() =>
  import('./pages/explorer/FileExplorerPage').then((module) => ({
    default: module.FileExplorerPage,
  }))
)
...
const QuarantinePage = lazy(() =>
  import('./pages/QuarantinePage').then((module) => ({ default: module.QuarantinePage }))
)
...
const InteractiveActivityPage = lazy(() =>
  import('./pages/InteractiveActivityPage').then((module) => ({
    default: module.InteractiveActivityPage,
  }))
)
          ...
          {[0, 1, 2, 3].map((index) => (
            <motion.div
              ...
              className={cn(
                ...
                index === 1 &&
                  'from-emerald-500/80 via-emerald-400 to-teal-600 shadow-emerald-500/30',
                index === 2 &&
                  'from-purple-600/80 via-purple-500 to-indigo-600 shadow-purple-500/30',
