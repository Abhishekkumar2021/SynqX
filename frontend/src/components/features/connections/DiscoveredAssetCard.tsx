...
import {
    Table, Layers, FileText, FileCode, Activity, Sparkles, Database
} from 'lucide-react';
    ...
    return (
        ...
        >
            <div className="p-6 flex flex-col gap-5">
                    ...
                    <div className="flex items-center gap-4 min-w-0">
                        ...
                        <div className="flex flex-col min-w-0 space-y-1">
                            ...
                            <div className="flex items-center gap-2">
                                <Badge variant="secondary" className="text-[10px] font-bold uppercase tracking-widest px-2 py-0 bg-muted/40 text-muted-foreground border-none h-5">
                ...
                {asset.fully_qualified_name && asset.fully_qualified_name !== asset.name && (
                    <div className="px-4 py-2.5 rounded-xl bg-muted/20 border border-border/10 group-hover:border-amber-500/10 transition-colors">
                        <span className="text-[11px] text-muted-foreground/70 font-mono truncate block leading-relaxed" title={asset.fully_qualified_name}>
            ...
            <div className={cn(
                ...
                <span className={cn("transition-colors", selected ? "text-amber-600" : "opacity-0 group-hover:opacity-100 text-amber-500/70")}>
                    Ready to Register
                </span>
            </div>
        </motion.div>
