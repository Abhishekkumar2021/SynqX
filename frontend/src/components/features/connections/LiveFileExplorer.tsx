...
export const LiveFileExplorer: React.FC<LiveFileExplorerProps> = ({ connectionId }) => {
  ...
  const rowVirtualizer = useVirtualizer({
    ...
    estimateSize: () => (viewMode === 'list' ? 64 : 140),
    overscan: 5,
  })
  ...
  return (
    <TooltipProvider>
      ...
      >
        ...
        <div
          ref={parentRef}
          className="flex-1 overflow-y-auto scrollbar-thin scrollbar-thumb-border/50 hover:scrollbar-thumb-border/80 scrollbar-track-transparent relative"
        >
              ...
              <Table wrapperClassName="rounded-none border-none shadow-none">
                <TableHeader className="bg-muted/10 sticky top-0 z-30 backdrop-blur-md border-b border-border/40">
                  <TableRow className="hover:bg-transparent border-none">
                    <TableHead className="pl-6 text-[10px] font-bold uppercase tracking-widest text-muted-foreground/60 w-[50%]">
                      Name
                    </TableHead>
                    <TableHead className="text-[10px] font-bold uppercase tracking-widest text-muted-foreground/60 w-[15%]">
                      Size
                    </TableHead>
                    <TableHead className="text-[10px] font-bold uppercase tracking-widest text-muted-foreground/60 w-[20%]">
                      Modified
                    </TableHead>
