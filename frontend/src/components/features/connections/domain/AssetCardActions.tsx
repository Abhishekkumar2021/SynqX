...
import { discoverAssetSchema, deleteAsset, getAssetSampleData, type QueryResponse } from '@/lib/api'
    ...
    <>
        ...
        <DropdownMenu>
          <DropdownMenuTrigger asChild>
            <Button
              variant="ghost"
              size="icon"
              className="h-7 w-7 rounded-lg hover:bg-muted text-muted-foreground transition-all"
            >
          ...
          <DropdownMenuContent
            align="end"
            className="w-52 rounded-xl border-border/40 shadow-xl backdrop-blur-md p-1"
          >
                ...
                >
                  <RefreshCw
                    className={cn(
                      ...
                      inferMutation.isPending && 'animate-spin'
                    )}
                  />
      ...
      <AlertDialog open={isDeleteAlertOpen} onOpenChange={setIsDeleteAlertOpen}>
        <AlertDialogContent onClick={(e) => e.stopPropagation()}>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              Are you sure you want to delete the asset "{assetName}"? This will remove its metadata
              and history.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
      ...
      <AssetSchemaDialog
        asset={
          isManaged
            ? item
            : { id: assetFqn, name: assetName, asset_type: assetType, connection_id: connectionId }
        }
