        ...
        {jobs.length === 0 ? (
          ...
          <div className="divide-y divide-border/10">
            {jobs.map((job) => (
              <div
                key={job.id}
                className="grid grid-cols-12 gap-4 px-8 py-4 hover:bg-muted/20 transition-colors items-center group"
              >
                ...
                <div
                  className="col-span-2 text-[10px] font-mono text-muted-foreground truncate"
                  title={job.worker_id}
                >
  ...
  return (
    ...
    >
      <div className="flex-1 min-h-0 border-t-0 bg-background/30 relative">
        <TabsContent
          value="runs"
          className="h-full m-0 data-[state=inactive]:hidden flex flex-col absolute inset-0"
        >
        ...
        <TabsContent
          value="alerts"
          className="h-full m-0 data-[state=inactive]:hidden absolute inset-0"
        >
