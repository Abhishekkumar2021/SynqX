    ...
    <div className="max-w-md w-full p-8 rounded-[2.5rem] border border-border/40 bg-muted/5 space-y-6 shadow-2xl relative overflow-hidden">
      ...
      <div className="space-y-2 relative z-10">
        ...
        <p className="text-sm text-muted-foreground font-medium leading-relaxed">
          The Explorer currently does not support rich interaction for{' '}
          <span className="text-foreground font-bold">{connectorType}</span>.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 gap-3 pt-4 relative z-10">
        <Button
          variant="outline"
          className="rounded-2xl font-bold text-xs gap-2 py-6 border-border/40 hover:bg-primary/5 hover:text-primary transition-all group"
        >
        ...
        <Button
          variant="ghost"
          className="rounded-2xl font-bold text-xs opacity-60"
          onClick={onBack}
        >
          Back to Connections
        </Button>
