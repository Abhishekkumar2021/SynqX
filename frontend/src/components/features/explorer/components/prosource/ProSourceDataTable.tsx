    ...
    <div className="flex-1 flex flex-col min-h-0 bg-background/50">
      ...
      <div className="px-8 py-3 border-b border-border/10 bg-muted/10 flex items-center justify-between shrink-0 backdrop-blur-sm">
        <div className="flex items-center gap-6">
          <Badge
            variant="outline"
            className="h-7 px-4 border-border/40 bg-background text-[10px] font-black text-foreground/80 tracking-widest uppercase rounded-full shadow-sm"
          >
          ...
          <div className="flex items-center gap-2">
            <Button
              variant="ghost"
              size="sm"
              className="h-7 px-3 gap-2 text-[9px] font-black uppercase tracking-widest text-muted-foreground hover:text-primary transition-all"
              onClick={() => refetch()}
            >
          ...
          <div className="p-8 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 max-w-[1600px] mx-auto pb-32">
            {results.map((record: any, i: number) => (
              <div
                ...
                className="p-6 rounded-[2rem] bg-card border border-border/40 hover:border-primary/30 hover:shadow-2xl transition-all group flex flex-col gap-5 relative overflow-hidden shadow-sm cursor-pointer"
              >
                <div className="flex items-start justify-between relative z-10">
                  ...
                  <div className="flex flex-col items-end">
                    <Badge
                      variant="outline"
                      className="text-[8px] font-black h-5 px-2 bg-muted/30 border-none uppercase tracking-widest mb-1"
                    >
                ...
                <div className="flex items-center justify-between pt-4 border-t border-border/10 relative z-10">
                  <Button
                    variant="ghost"
                    className="h-8 px-4 rounded-xl text-[9px] font-black uppercase tracking-widest text-primary opacity-0 group-hover:opacity-100 transition-all bg-primary/5 hover:bg-primary/10"
                  >
                    Inspect Record
                  </Button>
                  <ArrowRight
                    size={14}
                    className="text-primary translate-x-2 opacity-0 group-hover:opacity-100 group-hover:translate-x-0 transition-all"
                  />
                </div>
      ...
      <div className="px-8 py-4 border-t border-border/10 bg-muted/5 flex items-center justify-between shrink-0 backdrop-blur-md">
        <div className="text-[10px] font-bold text-muted-foreground uppercase tracking-widest opacity-60">
          Showing {pageOffset + 1} - {Math.min(pageOffset + pageSize, data?.total_count || 0)} of{' '}
        ...
        <div className="flex items-center gap-2">
          <Button
            variant="outline"
            size="sm"
            className="h-9 px-4 rounded-xl font-bold uppercase text-[9px] tracking-widest gap-2 active:scale-95 disabled:opacity-30"
