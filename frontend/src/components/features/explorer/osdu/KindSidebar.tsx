      ...
      <div className="p-5 border-b border-border/10 bg-muted/10 flex items-center justify-between shrink-0">
        <div className="flex items-center gap-3">
          ...
          <div className="flex flex-col">
            <span className="text-[10px] font-black uppercase tracking-[0.2em] text-foreground/60 leading-none">
              Catalog
            </span>
          ...
          {filteredKinds.map((kind) => (
            ...
            >
              ...
              <div className="flex flex-col min-w-0">
                ...
                <span
                  className={cn(
                    'text-[8px] font-black uppercase opacity-40 tracking-tighter',
                    selectedKind === kind.full_kind && 'text-primary-foreground/60'
                  )}
                >
                  {kind.group}
                </span>
