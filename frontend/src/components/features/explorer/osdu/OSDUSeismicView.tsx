...
import { Activity, Waves, Map as MapIcon, Database } from 'lucide-react';
    ...
    return (
        <div className="p-8 space-y-8 animate-in fade-in duration-500">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <Card className="bg-background/50 border-border/40">
                    <CardHeader className="flex flex-row items-center justify-between pb-2">
                        <CardTitle className="text-sm font-medium text-muted-foreground uppercase tracking-widest">Seismic Surveys</CardTitle>
                ...
                <Card className="bg-background/50 border-border/40">
                    <CardHeader className="flex flex-row items-center justify-between pb-2">
                        <CardTitle className="text-sm font-medium text-muted-foreground uppercase tracking-widest">Ecosystem Coverage</CardTitle>
                        <MapIcon className="h-4 w-4 text-emerald-500" />
                    </CardHeader>
                    <CardContent>
                        <div className="text-2xl font-bold">SDMS <span className="text-xs text-muted-foreground font-normal">Active</span></div>
                    </CardContent>
                </Card>
            </div>
            ...
            <div className="p-12 text-center border-2 border-dashed border-border/40 rounded-[3rem] bg-muted/5 opacity-40">
                ...
                <p className="text-sm text-muted-foreground max-w-sm mx-auto mt-2">Specialized seismic trace viewing and SEG-Y header inspection coming soon.</p>
            </div>
        </div>
    );
};
