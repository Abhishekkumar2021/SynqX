        ...
        <div className="flex-1 max-w-3xl relative group">
            ...
            <Sheet open={isBuilderOpen} onOpenChange={setIsBuilderOpen}>
              ...
              <SheetContent className="w-screen sm:max-w-none p-0 border-l border-border/40 bg-background/95 backdrop-blur-2xl shadow-2xl flex flex-col">
                ...
                <div className="flex-1 overflow-hidden p-6 bg-background/50">
                  <QueryBuilder initialQuery={localQuery} onQueryChange={(q) => setLocalQuery(q)} />
                </div>
          ...
          {incorrectField && (
            ...
            >
              <Sparkles size={10} />
              <span>
                Did you mean <code className="bg-amber-500/20 px-1 rounded">{incorrectField}:</code>
                ? The field <b>{incorrectField}</b> is at the root level.
              </span>
            </motion.div>
          )}
        </div>
              ...
              <Tooltip>
                <TooltipTrigger asChild>
                  <Button
                    variant="ghost"
                    size="icon"
                    className="h-10 w-10 rounded-xl hover:bg-muted/50 text-muted-foreground"
                  >
                    <Code size={18} />
                  </Button>
                </TooltipTrigger>
                <TooltipContent
                  side="bottom"
                  align="end"
                  className="w-[400px] p-0 border-border/40 bg-background/95 backdrop-blur-xl shadow-2xl"
                >
