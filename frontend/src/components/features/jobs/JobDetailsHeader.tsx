      ...
      <div className="flex items-center gap-4 md:gap-5 min-w-0">
        ...
        <div className="flex flex-col gap-1 min-w-0">
          ...
          <div className="hidden sm:flex items-center gap-2 text-[9px] md:text-[10px] font-bold text-muted-foreground/40 uppercase tracking-[0.2em] whitespace-nowrap overflow-hidden">
            ...
            <span
              className="hover:text-primary cursor-pointer transition-colors truncate max-w-[100px] md:max-w-[200px]"
          ...
          <div className="flex items-center gap-3">
            <div
              className="flex items-center gap-2 md:gap-2.5 group cursor-pointer min-w-0"
              onClick={() => copyToClipboard(job.id.toString(), 'Job ID')}
            >
            ...
            <StatusBadge
              ...
              className="h-5 text-[8px] md:text-[9px] px-2 shrink-0"
            />
          </div>
        ...
        <div className="flex items-center gap-2">
          <div className="flex items-center gap-2">
            ...
            {(job.status === 'failed' || job.status === 'cancelled') && (
              ...
              >
                <RefreshCw
                  className={cn('h-3.5 w-3.5 text-primary', isRetryPending && 'animate-spin')}
                />
          ...
          <div className="flex items-center bg-background/40 md:bg-muted/30 rounded-xl p-1 border border-border/40">
            ...
            <DropdownMenu>
              ...
              <DropdownMenuContent
                align="end"
                className="w-56 rounded-xl p-1.5 border-border/60 shadow-2xl backdrop-blur-xl bg-background/90"
              >
                <DropdownMenuItem
                  className="rounded-lg gap-2.5 cursor-pointer font-bold text-[10px] uppercase tracking-wider py-2"
                  onClick={() => copyToClipboard(window.location.href, 'Direct Link')}
                >
