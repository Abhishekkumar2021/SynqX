...
export const JobLogViewer: React.FC<JobLogViewerProps> = ({ jobId, status, queueName }) => {
  ...
  const handleClearView = () => {
    ...
    toast.info('Terminal view cleared', {
      description: 'New incoming logs will still be displayed.',
    })
  }
          ...
          <div className="flex items-center gap-1.5">
            ...
            <div className="flex items-center bg-muted/20 rounded-lg p-0.5 border border-border/40">
              <DropdownMenu>
                ...
                <DropdownMenuContent
                  align="end"
                  className="w-48 glass-card border-border/40 rounded-xl p-1 shadow-2xl"
                >
              ...
              <Tooltip>
                <TooltipTrigger asChild>
                  <Button
                    ...
                    className={cn(
                      ...
                      isAutoScroll ? 'text-primary bg-primary/10' : 'text-muted-foreground/60'
                    )}
                  >
                    {isAutoScroll ? (
                ...
                <TooltipContent className="text-[10px] font-bold uppercase tracking-widest">
                  {isAutoScroll ? 'Lock Scroll' : 'Follow'}
                </TooltipContent>
              </Tooltip>
            ...
            <DropdownMenu>
              ...
              <DropdownMenuContent
                align="end"
                className="w-56 glass-card border-border/40 rounded-xl p-1 shadow-2xl"
              >
                <DropdownMenuLabel className="text-[9px] font-bold uppercase opacity-40 px-3 py-2">
                  Terminal Config
                </DropdownMenuLabel>
                <DropdownMenuCheckboxItem
                  checked={wordWrap}
                  onCheckedChange={setWordWrap}
                  className="text-[10px] font-bold uppercase rounded-lg cursor-pointer"
                >
            ...
            <DropdownMenu>
              ...
              <DropdownMenuContent
                align="end"
                className="w-56 glass-card border-white/10 rounded-xl p-1 shadow-2xl"
              >
                <DropdownMenuItem
                  onClick={handleClearView}
                  className="text-[10px] font-bold uppercase rounded-lg py-2 cursor-pointer text-destructive focus:text-destructive focus:bg-destructive/5"
                >
              ...
              {status === 'queued' ? (
                <>
                  ...
                  <div className="space-y-1">
                    <span className="font-bold uppercase tracking-[0.3em] block">
                      Waiting for Agent
                    </span>
        ...
        <div className="px-5 py-1.5 bg-muted/30 border-t border-border/40 flex items-center justify-between text-[9px] text-muted-foreground/40 backdrop-blur-md">
          ...
          <div className="flex items-center gap-3">
            <button
              ...
              className="hover:text-primary font-bold uppercase tracking-tighter"
            >
              Top
            </button>
            <button
