    ...
    return (
        <div className="flex flex-col h-full w-full p-2 md:p-4 gap-4">
            ...
            <div className="flex-1 w-full relative overflow-hidden bg-background rounded-xl border border-border/10">
                ...
                <div className={cn(
                    "absolute top-0 right-0 w-full md:w-112.5 h-full glass-panel rounded-none! shadow-[0_0_100px_rgba(0,0,0,0.5)] flex flex-col overflow-hidden z-100 transition-all duration-700 cubic-bezier(0.32, 0.72, 0, 1) border-l border-border/20",
