  ...
  return (
    <div
      className={cn(
        ...
        selected &&
          'ring-1 ring-primary/40 ring-offset-4 ring-offset-background scale-[1.02] z-50 border-primary/60',
              ...
              <div className="ml-auto flex items-center gap-1">
                ...
                {!isReadOnly && (
                  <DropdownMenu>
                    ...
                    <DropdownMenuContent
                      align="end"
                      className="w-44 rounded-2xl bg-background/95 backdrop-blur-xl border-border/40 shadow-2xl p-1.5 ring-1 ring-white/10"
                    >
                      <DropdownMenuItem
                ...
                {nodeData.rowsProcessed && nodeData.rowsProcessed > 0 ? (
                  ...
                  >
                    ...
                    <div className="flex items-baseline gap-1">
                      ...
                      <span className="text-[9px] font-bold opacity-30 uppercase text-primary/60">
                        rows
                      </span>
                    </div>
                  </div>
              ...
              <div className="flex items-center gap-2.5">
                <div
                  className={cn(
                    ...
                    isRunning
                      ? 'bg-primary animate-pulse shadow-primary/40'
