        ...
        <div className="flex-1 overflow-y-auto px-8 py-6 custom-scrollbar bg-background/50">
          {isLoading ? (
            ...
            <div className="h-full flex flex-col items-center justify-center text-center opacity-40">
              ...
              <p className="text-sm max-w-xs mx-auto mt-2">Deploy your first changes to initialize the version control history.</p>
            </div>
          ) : (
                ...
                return (
                  ...
                  >
                    ...
                    <div className={cn(
                        ...
                        isSelected ? "bg-primary border-primary text-primary-foreground scale-110" : "bg-transparent border-border/40 group-hover:border-primary/40"
                    )}>
                        {isSelected ? <CheckCircle2 className="h-4 w-4" /> : <div className="h-1 w-1 rounded-full bg-border group-hover:bg-primary/40" />}
                    </div>
