        ...
        <>
            <div className="rounded-[1.5rem] border border-destructive/30 bg-destructive/5 backdrop-blur-xl shadow-xl overflow-hidden group/danger relative">
                ...
                <div className="p-6 relative z-10">
                    ...
                    <Button 
                        variant="destructive" 
                        className="w-full rounded-xl h-11 font-black uppercase tracking-[0.2em] text-[10px] shadow-lg shadow-destructive/20 hover:scale-[1.02] active:scale-[0.98] transition-all border-2 border-destructive/20 bg-destructive text-destructive-foreground"
                ...
                <DialogContent className="sm:max-w-md rounded-[2rem] p-8">
                    ...
                    <DialogFooter className="mt-8 gap-3">
                        ...
                        <Button 
                            ...
                            className="rounded-2xl h-12 flex-1 font-black uppercase tracking-[0.2em] text-[10px] shadow-xl shadow-destructive/20"
                        >
                            Delete Workspace
                        </Button>
                    </DialogFooter>
