  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogTrigger asChild>
        <Button
          size="sm"
          className="rounded-lg shadow-lg h-9 px-4 gap-2 text-xs font-bold transition-all hover:scale-105 active:scale-95 shadow-primary/20"
        >
          <UserPlus size={14} />
            ...
            <Select value={inviteRole} onValueChange={(v: any) => setInviteRole(v)}>
              ...
              <SelectContent className="rounded-xl border-border/60 shadow-2xl">
                <SelectItem
                  ...
                  className="rounded-lg font-bold text-xs py-3"
                >
