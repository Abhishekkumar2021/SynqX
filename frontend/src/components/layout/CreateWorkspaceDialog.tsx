          ...
          <div className="p-8 space-y-8">
            <div className="space-y-6">
              ...
              <div className="space-y-3">
                <Label
                  htmlFor="ws-name"
                  className="text-[10px] font-bold uppercase tracking-widest text-muted-foreground/70 px-1"
                >
                  Organization Name
                </Label>
                <Input
            ...
            <div className="p-4 rounded-2xl bg-primary/5 border border-primary/10 flex gap-3 items-start">
              ...
              <p className="text-[11px] text-muted-foreground leading-normal font-medium">
                Workspaces provide logical isolation for your connectors and pipelines. You can
                invite team members and assign roles after launch.
              </p>
            </div>
          </div>
          ...
          <DialogFooter className="p-8 pt-0 flex flex-col sm:flex-row gap-3">
            ...
            <Button
              ...
              className={cn(
                ...
                mutation.isPending
                  ? 'opacity-80'
                  : 'shadow-xl shadow-primary/20 hover:shadow-primary/40 hover:-translate-y-0.5 active:translate-y-0'
              )}
            >
              {mutation.isPending ? (
                <>
