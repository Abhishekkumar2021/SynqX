    ...
    <DropdownMenu open={isOpen} onOpenChange={setIsOpen}>
      <DropdownMenuTrigger asChild>
        <Button
          variant="ghost"
          size="icon"
          className="relative text-muted-foreground hover:text-foreground hover:bg-muted/10 rounded-full h-10 w-10"
        >
      ...
      <DropdownMenuContent
        align="end"
        className="w-80 glass-card rounded-2xl shadow-2xl p-0 overflow-hidden border-border/40"
      >
            ...
            <Button
              ...
              onClick={() => {
                alerts
                  ...
                  .forEach((a) => acknowledgeMutation.mutate(a.id))
              }}
            >
              Mark all read
            </Button>
