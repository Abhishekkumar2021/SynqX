...
import { Workflow, PanelLeft, LogOut, User, Building2, Key, Bell, ChevronRight } from 'lucide-react'
                  ...
                  {location.pathname.startsWith('/docs') ? (
                    ...
                    NAV_STRUCTURE.map((group, groupIndex) => (
                      <div
                        ...
                        className={cn(
                          'flex flex-col',
                          isSidebarCollapsed ? 'items-center w-full gap-1' : 'gap-1 mb-2'
                        )}
                      >
                        {!isSidebarCollapsed && (
                          <motion.h4
                      ...
                      <button
                        className={cn(
                          ...
                          isSidebarCollapsed
                            ...
                            : 'h-16 px-3 gap-3 hover:bg-background/60 hover:border-border/30 hover:shadow-md'
                        )}
                      >
                        ...
                        <AnimatePresence mode="wait">
                          {!isSidebarCollapsed && (
                            ...
                            >
                              <span className="text-[13px] font-semibold truncate w-36 text-foreground/90">
                                {user.full_name || 'Operator'}
                              </span>
                              <span className="text-[10px] text-muted-foreground/70 truncate w-36">
                                {user.email}
                              </span>
                            </motion.div>
                          )}
                    ...
                    >
                      ...
                      <div className="space-y-1">
                        {[
                          ...
                          {
                            label: 'Security',
                            desc: 'API keys & Access',
                            icon: Key,
                            tab: 'security',
                          },
                          {
                            label: 'Notifications',
                            desc: 'Alert protocols',
                            icon: Bell,
                            tab: 'notifications',
                          },
                        ].map((item, idx) => (
                      ...
                      >
                        ...
                        <div className="flex flex-col gap-0.5">
                          ...
                          <span className="text-[10px] opacity-60 font-normal leading-none">
                            Terminate session
                          </span>
                        </div>
                      </DropdownMenuItem>
