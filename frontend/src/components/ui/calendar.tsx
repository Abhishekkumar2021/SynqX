...
function Calendar({
  ...
  return (
    <DayPicker
      ...
      className={cn('bg-transparent group/calendar p-3 [--cell-size:--spacing(9)]', className)}
      ...
      classNames={{
        ...
        nav: cn(
          'flex items-center gap-1 w-full absolute top-0 inset-x-0 justify-between px-1 z-20',
        ...
        caption_label: cn(
          'select-none font-bold text-xs uppercase tracking-wider text-foreground/80'
        ),
        table: 'w-full border-collapse',
        weekdays: cn('flex justify-between mb-0', defaultClassNames.weekdays),
        weekday: cn(
          'text-muted-foreground/40 w-9 font-bold text-[0.6rem] select-none uppercase tracking-widest text-center'
        ),
        week: cn('flex w-full mt-0 gap-0', defaultClassNames.week),
        day: cn(
          'relative w-9 h-9 p-0 text-center group/day aspect-square select-none overflow-visible'
        ),
        ...
        today: cn(
          'relative after:absolute after:bottom-1 after:left-1/2 after:-translate-x-1/2 after:size-1 after:bg-primary/60 after:rounded-full'
        ),
