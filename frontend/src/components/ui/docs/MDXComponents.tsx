  ...
  const content = (
    ...
    >
      ...
      <div className="flex-1">
        {title && (
          <h4 className="font-bold text-lg mb-2 text-foreground tracking-tight">{title}</h4>
        )}
        {description && (
...
export const Step = ({ title, children, number }: any) => (
  <div className="relative pl-12 group">
    ...
    {title && (
      <h3 className="text-xl font-bold mb-3 mt-0 tracking-tight text-foreground">{title}</h3>
    )}
  ...
  return (
    ...
    >
      ...
      <div className="flex-1 flex flex-col gap-1 min-w-0">
        {title && (
          <div className="font-bold text-[10px] uppercase tracking-widest opacity-80">{title}</div>
        )}
...
export const Tab = ({ children, value, label }: any) => (
  <TabsContent value={value || label}>{children}</TabsContent>
)
...
export const components = {
  ...
  h1: (props: any) => (
    <h1
      className="scroll-m-20 text-4xl font-bold tracking-tight mt-12 mb-6 text-foreground leading-tight"
      {...props}
    />
  ),
  ...
  h2: (props: any) => (
    <h2
      className="scroll-m-20 text-2xl font-bold tracking-tight mt-10 mb-4 pb-2 border-b border-border/40 text-foreground/90 flex items-center gap-2"
      {...props}
    />
  ),
  ...
  h3: (props: any) => (
    <h3
      className="scroll-m-20 text-xl font-semibold tracking-tight mt-8 mb-3 text-foreground/80"
      {...props}
    />
  ),
  ...
  h4: (props: any) => (
    <h4
      className="scroll-m-20 text-lg font-semibold tracking-tight mt-6 mb-2 text-foreground/85"
      {...props}
    />
  ),
  ...
  p: (props: any) => (
    <p
      className="leading-relaxed mb-5 text-muted-foreground font-medium text-[15px] max-w-4xl"
      {...props}
    />
  ),
  ...
  ul: (props: any) => (
    <ul
      className="list-disc pl-6 mb-6 space-y-2 text-muted-foreground font-medium text-[14.5px]"
      {...props}
    />
  ),
  ...
  ol: (props: any) => (
    <ol
      className="list-decimal pl-6 mb-6 space-y-2 text-muted-foreground font-medium text-[14.5px]"
      {...props}
    />
  ),
  ...
  code: (props: any) => {
    ...
    if (!props.className) {
      return (
        <code
          className="bg-muted/40 dark:bg-white/5 px-1.5 py-0.5 rounded-md text-primary font-mono font-semibold text-[0.9em] border border-border/20"
          {...props}
        />
      )
    }
    ...
    return (
      <code
        className="block px-5 py-4 overflow-x-auto custom-scrollbar bg-transparent"
        {...props}
      />
    )
  },
  ...
  thead: (props: any) => <thead className="bg-muted/30" {...props} />,

  th: (props: any) => (
    <th
      className="px-4 py-3 bg-muted/30 font-semibold text-[12px] uppercase tracking-wider text-foreground/70 border-b border-border/40"
      {...props}
    />
  ),
  ...
  td: (props: any) => (
    <td
      className="px-4 py-3 border-b border-border/5 font-medium text-muted-foreground"
      {...props}
    />
  ),

  tr: (props: any) => <tr className="transition-colors hover:bg-muted/20" {...props} />,

  // Blockquote
  blockquote: (props: any) => (
    <blockquote
      className="border-l-4 border-primary rounded-r-xl bg-primary/5 px-6 py-4  my-8 text-lg font-medium text-foreground/80 relative overflow-hidden backdrop-blur-sm shadow-lg"
      {...props}
    />
  ),

  // Horizontal rule
  hr: (props: any) => <hr className="my-12 border-border/30" {...props} />,
