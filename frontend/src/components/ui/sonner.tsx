...
const Toaster = ({ ...props }: ToasterProps) => {
  ...
  return (
    <>
      <style>{`
        .toast-hover-close [data-close-button] {
          opacity: 0 !important;
          transition: opacity 0.2s ease-in-out !important;
        }
        .toast-hover-close:hover [data-close-button] {
          opacity: 1 !important;
        }
      `}</style>
      <Sonner
        ...
        toastOptions={{
          classNames: {
            ...
            closeButton:
              'group-[.toast]:!bg-background/20 group-[.toast]:backdrop-blur-md group-[.toast]:!text-muted-foreground group-[.toast]:!border-border/40 group-[.toast]:hover:!bg-background/40 group-[.toast]:transition-all group-[.toast]:ring-1 group-[.toast]:ring-white/10',
          },
        }}
        style={
          {
        ...
        icons={{
          ...
          error: (
            <motion.div
              initial={{ x: -5 }}
              animate={{ x: 0 }}
              transition={{ type: 'spring', repeat: 2, repeatType: 'reverse', duration: 0.1 }}
            >
