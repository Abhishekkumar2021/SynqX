...
| :--- | :--- | :--- |
| 👁️ **Viewer** | `Read-Only` | Can view all pipelines, connections, assets, and execution history within the workspace. Cannot make any changes. |
| ✍️ **Editor** | `Read & Write` | Has all Viewer permissions, plus the ability to create, update, and trigger pipelines, connections, and assets. |
