...
export const CONNECTOR_META: Record<string, ConnectorMetadata> = {
  osdu: {
    id: 'osdu',
    name: 'OSDU Data Platform',
    description: 'Open Subsurface Data Universe (Energy Data).',
    icon: <Layers />,
    category: 'Domain',
  ...
  prosource: {
    id: 'prosource',
    name: 'SLB ProSource',
    description: 'Seabed/LogDB Corporate Data Management.',
    icon: <Database />,
    category: 'Domain',
  ...
  mariadb: {
    id: 'mariadb',
    name: 'MariaDB',
    description: 'High performance open-source database.',
    icon: <Database />,
    category: 'Database',
  ...
  sqlite: {
    id: 'sqlite',
    name: 'SQLite',
    description: 'C-language library embedded database.',
    icon: <Database />,
    category: 'Database',
  ...
  duckdb: {
    id: 'duckdb',
    name: 'DuckDB',
    description: 'Embeddable analytical database (OLAP).',
    icon: <Database />,
    category: 'Database',
  ...
  snowflake: {
    id: 'snowflake',
    name: 'Snowflake',
    description: 'Cloud-native data warehousing platform.',
    icon: <Cloud />,
    category: 'Warehouse',
  ...
  databricks: {
    id: 'databricks',
    name: 'Databricks',
    description: 'Unified data analytics platform (Lakehouse).',
    icon: <Cloud />,
    category: 'Warehouse',
  ...
  google_sheets: {
    id: 'google_sheets',
    name: 'Google Sheets',
    description: 'Spreadsheets as a real-time data source.',
  ...
  mongodb: {
    id: 'mongodb',
    name: 'MongoDB',
    description: 'Source-available document database.',
    icon: <FileJson />,
    category: 'Database',
  ...
  dynamodb: {
    id: 'dynamodb',
    name: 'DynamoDB',
    description: 'Serverless key-value NoSQL database.',
    icon: <Database />,
    category: 'Database',
  ...
  local_file: {
    id: 'local_file',
    name: 'Local File',
    description: 'Read CSV, JSON, and Parquet from disk.',
    icon: <HardDrive />,
    category: 'File',
  ...
  s3: {
    id: 's3',
    name: 'Amazon S3',
    description: 'Scalable object storage in AWS.',
    icon: <Cloud />,
    category: 'File',
  ...
  gcs: {
    ...
    description: 'Unified object storage from Google Cloud.',
    icon: <Cloud />,
    category: 'File',
    color: 'text-blue-500 bg-blue-500/10 border-blue-500/20',
  },
  ...
  rest_api: {
    id: 'rest_api',
    name: 'REST API',
    description: 'Connect to generic HTTP endpoints.',
    icon: <Globe />,
    category: 'API',
  ...
  graphql: {
    id: 'graphql',
    name: 'GraphQL',
    description: 'Query and fetch data from GraphQL APIs.',
    icon: <Globe />,
    category: 'API',
  ...
  airtable: {
    id: 'airtable',
    name: 'Airtable',
    description: 'Cloud collaboration service (spreadsheet-database hybrid).',
    icon: <FileSpreadsheet />,
    category: 'API',
    color: 'text-blue-500 bg-blue-500/10 border-blue-500/20',
  },
  custom_script: {
    id: 'custom_script',
    name: 'Custom Script',
    description: 'Execute Python or Shell scripts to extract data.',
    icon: <Code />,
    category: 'Generic',
  ...
  singer_tap: {
    id: 'singer_tap',
    name: 'Singer Tap',
    description: 'Run any Singer-compliant Tap to ingest data.',
    icon: <Code />,
    category: 'Generic',
...
export const CONNECTOR_CONFIG_SCHEMAS: Record<string, any> = {
  osdu: {
    fields: [
      {
        name: 'osdu_url',
        label: 'OSDU Instance URL',
        type: 'text',
        required: true,
        placeholder: 'https://osdu.example.com',
      },
      {
      ...
      {
        name: 'default_acl',
        label: 'Default ACL (JSON)',
        type: 'textarea',
        language: 'json',
        placeholder:
          '{"viewers": ["data.default.viewers@opendes.osdu.com"], "owners": ["data.default.owners@opendes.osdu.com"]}',
      },
      {
        name: 'default_legal',
        label: 'Default Legal Tags (JSON)',
        type: 'textarea',
        language: 'json',
        placeholder:
          '{"legaltags": ["opendes-default-legal"], "otherRelevantDataCountries": ["US"]}',
      },
    ],
  },
  prosource: {
    ...
    fields: [
      {
        ...
        type: 'text',
        required: true,
        placeholder: 'cluster.abc.region.redshift.amazonaws.com',
      },
    ...
    fields: [
      {
        ...
        label: 'Database Path',
        type: 'text',
        placeholder: '/path/to/duck.db (Leave empty for in-memory)',
      },
      {
        name: 'memory',
  ...
  s3: {
    fields: [
      ...
      {
        name: 'max_depth',
        label: 'Max Depth (None for unlimited)',
        type: 'number',
        min: 0,
        dependency: { field: 'recursive', value: true },
      },
      {
        name: 'exclude_patterns',
        label: 'Exclude Patterns',
        type: 'text',
        placeholder: 'e.g. logs, temp, backup',
      },
    ],
  },
  gcs: {
  ...
  azure_blob: {
    fields: [
      ...
      {
        name: 'connection_string',
        label: 'Connection String (Optional override)',
        type: 'password',
      },
      {
        name: 'recursive',
      ...
      },
      {
        ...
        label: 'Exclude Patterns',
        type: 'text',
        placeholder: 'e.g. archive, hidden',
      },
    ],
  },
  sftp: {
  ...
  kafka: {
    fields: [
      ...
      },
      {
        ...
        dependency: { field: 'security_protocol', value: ['SASL_PLAINTEXT', 'SASL_SSL'] },
      },
      {
  ...
  google_sheets: {
    fields: [
      ...
      },
      {
        ...
        required: true,
        language: 'json',
        dependency: { field: 'auth_type', value: 'service_account' },
        placeholder: '{ ... }',
      },
      {
        name: 'api_key',
  ...
  salesforce: {
    fields: [
      ...
      { name: 'security_token', label: 'Security Token', type: 'password', required: true },
      {
        ...
        type: 'select',
        options: [
          { label: 'Production (login)', value: 'login' },
  ...
  stripe: {
    fields: [{ name: 'api_key', label: 'Secret API Key', type: 'password', required: true }],
  },
  rabbitmq: {
    fields: [
  ...
  rest_api: {
    fields: [
      ...
      // Advanced Data Mapping
      {
        ...
        type: 'text',
        placeholder: 'e.g. data.items or results (leave empty for root array)',
      },
      ...
      },
      {
        ...
        type: 'number',
        defaultValue: 100,
        dependency: { field: 'pagination_type', value: ['limit_offset', 'page_number'] },
      },
      {
        name: 'limit_param',
        ...
        type: 'text',
        defaultValue: 'limit',
        dependency: { field: 'pagination_type', value: 'limit_offset' },
      },
      {
        name: 'offset_param',
      ...
      },
      {
        ...
        type: 'text',
        defaultValue: 'page',
        dependency: { field: 'pagination_type', value: 'page_number' },
      },
      {
      ...
      {
        name: 'default_params',
        label: 'Default Query Params (JSON)',
        type: 'textarea',
        language: 'json',
  ...
  local_file: {
    fields: [
      ...
      },
      {
        ...
        label: 'Exclude Patterns',
        type: 'text',
        placeholder: 'e.g. node_modules, logs, .git',
      },
    ],
  },
  custom_script: {
    fields: [
      {
        name: 'base_path',
        label: 'Base Script Path (Optional)',
        type: 'text',
        placeholder: '/opt/scripts',
      },
      {
        name: 'env_vars',
        label: 'Global Env Vars (JSON)',
        type: 'textarea',
        language: 'json',
        placeholder: '{"API_KEY": "..."}',
      },
    ...
    fields: [
      {
        ...
        type: 'text',
        required: true,
        placeholder: 'e.g. tap-adwords',
      },
      {
        name: 'config',
        label: 'Tap Config (JSON)',
        type: 'textarea',
        language: 'json',
        required: true,
        placeholder: '{ "api_key": "..." }',
      ...
      {
        name: 'catalog',
        label: 'Catalog/Properties (Optional JSON)',
        type: 'textarea',
        language: 'json',
      },
  ...
  dbt: {
    fields: [
      ...
      },
      {
        ...
        type: 'text',
        placeholder: 'https://github.com/org/dbt-project.git',
      },
...
export const CONNECTOR_TYPE_INFO: Record<string, any> = Object.entries(CONNECTOR_META).reduce(
  (acc, [key, meta]) => {
    acc[key] = {
      label: meta.name,
      group: meta.category,
