...
export const NODE_DEFINITIONS: { category: string; items: OperatorDefinition[] }[] = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        fields: [
          {
            name: 'allow_schema_evolution',
            label: 'Schema Evolution',
            type: 'boolean',
            configKey: 'allow_schema_evolution',
            tooltip:
              'If enabled, SynqX will automatically issue ALTER TABLE commands if new columns are detected in the incoming data.',
          },
        ],
      },
    ],
    ...
    items: [
      {
        ...
        fields: [
          ...
          },
          {
            ...
            tooltip:
              'Inner: intersection only. Left: all from left dataset + matches from right. Outer: all from both.',
          },
        ],
      },
      {
      ...
      },
      {
        ...
        fields: [
          ...
          },
          {
            ...
            label: 'Aggregates',
            type: 'json',
            configKey: 'aggregates',
            placeholder: '{ "salary": "mean", "id": "count" }',
            tooltip:
              'Map of column names to aggregation functions. Available: sum, count, mean, min, max, unique_count.',
          },
        ],
      },
      {
        ...
        fields: [
          {
            ...
            tooltip:
              'List of validation rules to apply. Checks: not_null, min_value, max_value, regex, in_list.',
          },
          {
            name: 'strict',
            ...
            configKey: 'strict',
            tooltip:
              'If enabled, the entire pipeline will fail on the first invalid row. If disabled, invalid rows are quarantined.',
          },
        ],
      },
      {
        ...
        fields: [
          {
            ...
            tooltip:
              'Only consider these columns when identifying duplicates. If empty, all columns are checked.',
          },
          {
            name: 'keep',
            label: 'Keep',
        ...
        fields: [
          {
            ...
            type: 'text',
            configKey: 'column',
            tooltip: 'The column to apply regex on.',
          },
          {
            name: 'pattern',
            label: 'Pattern',
            ...
            configKey: 'pattern',
            placeholder: '\\d+',
            tooltip: 'Regex pattern to search for.',
          },
          {
            name: 'replacement',
            label: 'Replacement',
            ...
            tooltip: 'String to replace matches with.',
          },
        ],
      },
      {
        ...
        fields: [
          {
            ...
            tooltip:
              'Must define a "transform(lf)" function that accepts and returns a Polars LazyFrame.',
          },
        ],
      },
      {
...
export const mapNodeTypeToOperator = (nodeType: string, operatorClass?: string) => {
  ...
  switch (nodeType?.toLowerCase()) {
    ...
    case 'merge':
      return OperatorType.MERGE
    case 'validate':
      return OperatorType.VALIDATE
    case 'noop':
