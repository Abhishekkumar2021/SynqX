  ...
  return (
    ...
    >
      <PageMeta
        ...
        description={description || 'SynqX Documentation'}
      />
      ...
      <nav className="flex items-center gap-3 mb-12 text-[11px] font-bold uppercase tracking-[0.25em] text-muted-foreground/40">
        ...
        <Link
          to="/docs"
          className="hover:text-primary transition-all duration-300 group flex items-center gap-2"
        >
          Docs
        </Link>
        {currentPath !== 'index' && (
