...
import {
  IntegrationItem,
  IntegrationCard,
} from '@/components/features/landing/IntegrationComponents'
  ...
  return (
    <div className="flex flex-col min-h-screen font-sans bg-background text-foreground overflow-x-hidden">
        ...
        <div className="flex items-center gap-4">
          ...
          <Link to="/login" className="hidden sm:block">
            <Button
              variant="ghost"
              size="sm"
              className="font-medium hover:bg-primary/10 hover:text-primary rounded-full px-4"
            >
              Sign In
            </Button>
          </Link>
      ...
      <main className="flex-1 pt-16">
          ...
          <div className="container px-4 md:px-6 mx-auto text-center space-y-10 relative z-10">
            ...
            <div className="space-y-6 max-w-4xl mx-auto animate-in fade-in slide-in-from-bottom-4 duration-700 delay-150">
              <h1 className="text-5xl md:text-7xl font-bold tracking-tight leading-[1.1]">
                ...
                <span className="text-gradient font-extrabold">At Light Speed</span>
              </h1>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-4 animate-in fade-in slide-in-from-bottom-8 duration-700 delay-300">
              <Link to="/dashboard">
                <Button
                  size="lg"
                  className="h-14 px-8 text-base rounded-full shadow-xl shadow-primary/20 hover:shadow-primary/30 hover:-translate-y-0.5 transition-all duration-300"
                >
                  Start Building Now
              ...
              <Link to="/docs">
                <Button
                  variant="outline"
                  size="lg"
                  className="h-14 px-8 text-base rounded-full glass-card hover:bg-secondary/50 transition-all border-border/50"
                >
                ...
                <div className="h-[450px] md:h-[550px] relative w-full overflow-hidden flex items-center justify-center bg-background/30">
                  ...
                  >
                    <div className="animate-float-medium">
                      <MockNode
                        icon={<Code2 className="text-chart-3" />}
                        title="Transform Py"
                        sub="Python 3.9"
                        type="transform"
                        status="running"
                  ...
                  >
                    <div className="animate-float-fast">
                      <MockNode
                        icon={<Shield className="text-chart-5" />}
                        title="PII Redact"
                        sub="Security Policy"
                        type="transform"
                      />
                  ...
                  >
                    <div className="animate-float-slow">
                      <MockNode
                        icon={<Globe className="text-chart-2" />}
                        title="Snowflake"
                        sub="Analytics DB"
                        type="sink"
                      />
              ...
              {[
                {
                  ...
                  desc: 'Drag and drop nodes to create complex data flows.',
                },
                {
                  icon: Zap,
                  title: 'Real-time Observability',
                  desc: 'Watch logs stream in real-time via WebSockets.',
                },
                {
                  icon: Shield,
                  title: 'Enterprise Security',
                  desc: 'RBAC, encrypted credentials, and VPC peering support.',
                },
                {
                  icon: Cpu,
                  title: 'Smart Scaling',
                  desc: 'Auto-scale workers based on pipeline load.',
                },
                {
                  icon: Lock,
                  title: 'Data Governance',
                  desc: 'PII detection and compliance-ready audit logs.',
                },
                {
                  icon: Clock,
                  title: 'Flexible Scheduling',
                  desc: 'Cron expressions, event triggers, or API-driven runs.',
                },
              ].map((feature, i) => (
                <FeatureCard
                  key={i}
        ...
        <section
          id="integrations"
          className="py-32 bg-muted/20 border-t border-border/40 overflow-hidden relative"
        >
            ...
            <div className="grid lg:grid-cols-2 gap-20 items-center">
              <div className="space-y-8 relative z-10">
                <div className="space-y-4">
                  ...
                  <p className="text-muted-foreground text-lg leading-relaxed">
                    SynqX supports 50+ native connectors including major databases, data warehouses,
                    and SaaS APIs.
                  </p>
                </div>
                ...
                <ul className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <IntegrationItem
                    icon={<Database className="h-4 w-4 text-chart-1" />}
                    text="PostgreSQL, MySQL"
                  />
                  <IntegrationItem
                    icon={<Globe className="h-4 w-4 text-chart-2" />}
                    text="Snowflake, BigQuery"
                  />
                  <IntegrationItem
                    icon={<Cable className="h-4 w-4 text-chart-3" />}
                    text="Salesforce, HubSpot"
                  />
                  <IntegrationItem
                    icon={<BarChart3 className="h-4 w-4 text-chart-4" />}
                    text="AWS S3, Azure Blob"
                  />
                </ul>
                ...
                <Link to="/connections">
                  <Button
                    variant="outline"
                    className="group h-12 px-6 glass-card hover:bg-primary/5 transition-all rounded-full border-border/60"
                  >
                    View All Connectors
              ...
              <div className="relative h-[500px] w-full flex items-center justify-center perspective-[1000px]">
                ...
                <IntegrationCard
                  ...
                  icon={<Globe />}
                  color="text-chart-2"
                  position="absolute top-10 left-10 animate-float-slow"
                />
                <IntegrationCard
                  name="Postgres"
                  icon={<Database />}
                  color="text-chart-1"
                  position="absolute bottom-20 left-0 animate-float-medium"
                />
                <IntegrationCard
                  name="S3 Bucket"
                  icon={<Server />}
                  color="text-chart-3"
                  position="absolute top-0 right-20 animate-float-fast"
                />
                <IntegrationCard
                  name="dbt Core"
                  icon={<Code2 />}
                  color="text-chart-4"
                  position="absolute bottom-10 right-10 animate-float-slow"
                />
              </div>
            </div>
          </div>
          ...
          <div className="container px-4 md:px-6 mx-auto text-center space-y-10 relative z-10">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-6">
              <Link to="/dashboard">
                <Button
                  size="lg"
                  className="h-14 px-10 text-lg rounded-full shadow-xl shadow-primary/20 hover:shadow-primary/40 transition-all hover:-translate-y-1 bg-primary text-primary-foreground"
                >
                  Start Free Trial
                </Button>
              </Link>
              <a
                href="#"
                className="h-14 px-10 text-lg rounded-full glass-card hover:bg-muted/50 transition-all flex items-center justify-center border-border/60"
              >
                Schedule Demo
              </a>
            </div>
