...
export const LoginPage: React.FC = () => {
  ...
  return (
    <div
      ref={containerRef}
      className="relative min-h-screen grid lg:grid-cols-2 overflow-hidden bg-background font-sans selection:bg-primary/20"
    >
            ...
            {[
              {
                ...
                desc: 'SOC2 Compliant security architecture',
              },
              ...
              <div
                key={idx}
                className="group flex items-center gap-4 p-4 rounded-2xl bg-black/5 dark:bg-white/5 border border-black/5 dark:border-white/5 backdrop-blur-sm hover:bg-black/10 dark:hover:bg-white/10 transition-all duration-300 hover:translate-x-1"
              >
          ...
          <div className="p-6 bg-black/5 dark:bg-white/5 backdrop-blur-xl rounded-2xl border border-black/5 dark:border-white/5 shadow-2xl relative overflow-hidden group">
            ...
            <blockquote className="space-y-4 relative z-10">
              <p className="text-base font-medium leading-relaxed text-zinc-700 dark:text-zinc-200 ">
                &ldquo;The real-time forensic logging capabilities alone have saved us hundreds of
                engineering hours.&rdquo;
              </p>
