                ...
                <div className="space-y-1.5">
                    <h2 className="text-3xl md:text-4xl font-bold tracking-tighter text-foreground flex items-center gap-3">
                        ...
                        {activeWorkspace && isRemoteGroup(activeWorkspace.default_agent_group) && (
                            <Badge variant="outline" className="h-7 px-3 rounded-xl bg-emerald-500/10 text-emerald-600 border-emerald-500/20 font-bold uppercase tracking-widest text-[9px] gap-1.5 hidden sm:flex">
                    ...
                    {isEditor && (
                        <>
                            ...
                            <Link to="/pipelines/new" className="w-full md:w-auto">
                                <Button size="sm" className="w-full md:w-auto rounded-xl shadow-lg shadow-primary/20 hover:shadow-primary/40 transition-all hover:scale-105 active:scale-95 font-semibold">
