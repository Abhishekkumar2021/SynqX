        ...
        <div className="relative z-20 space-y-10 max-w-lg animate-in fade-in slide-in-from-left-8 duration-1000 delay-200">
          ...
          <div className="space-y-4">
            {[
              ...
              <div
                key={idx}
                className="group flex items-center gap-4 p-4 rounded-2xl bg-zinc-900/5 dark:bg-white/5 border border-zinc-900/5 dark:border-white/5 backdrop-blur-sm hover:bg-zinc-900/10 dark:hover:bg-white/10 transition-all duration-300 hover:translate-x-1"
              >
