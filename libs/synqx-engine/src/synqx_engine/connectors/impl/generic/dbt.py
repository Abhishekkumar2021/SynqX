...
class DbtConnector(BaseConnector):
            ...
            for key, node in manifest.get("nodes", {}).items():
                if node.get("resource_type") == "model":
                    ...
                    assets.append({
                        ...
                        "type": "table", # dbt models usually materialize as tables/views
    ...
    def read_batch(
        ...
        raise NotImplementedError("Direct data reading from dbt connector not supported. Use the underlying warehouse connector.")
